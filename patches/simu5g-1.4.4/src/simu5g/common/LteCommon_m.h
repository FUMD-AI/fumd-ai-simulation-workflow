...
constexpr unsigned short NR_UE_MIN_ID = 5121;  // KG (8/7/2026) 1024 + 4096 LTE UEs + 1
constexpr unsigned short BGUE_MIN_ID  = 9217;  // KG (8/7/2026) NR_UE_MIN_ID + 4096 NR UEs
...
/**
 * Struct generated from simu5g/common/LteCommon.msg:234 by opp_msgtool.
 */
struct RemoteUnitPhyData
{
    RemoteUnitPhyData();
...
/**
 * Struct generated from simu5g/common/LteCommon.msg:240 by opp_msgtool.
 */
struct FeedbackRequest
{
    FeedbackRequest();
